-- Migration: Create tables for KiotViet data caching and sync management
...
CREATE TABLE IF NOT EXISTS kiotviet_products (
  ...
  CONSTRAINT fk_user_products FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS kiotviet_customers (
  ...
  CONSTRAINT fk_user_customers FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS kiotviet_orders (
  ...
  CONSTRAINT fk_user_orders FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS kiotviet_invoices (
  ...
  CONSTRAINT fk_user_invoices FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
